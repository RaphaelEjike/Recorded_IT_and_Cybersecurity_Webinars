...
## 1. Illuminate Adversaries with Cyber Threat Intelligence. (https://youtube.com/playlist?list=PLs4eo9Tja8biPtqUQfGj_W8Iw-t6YoGMg&si=N_JZW3Mi9q_ffCe7)

What I Liked: 
- I've been listening to the BluePrint Podcast series, and I must say, it's been an enlightening journey through MITRE’s 11 Strategies of a World-Class Cyber Security Operations Center. Each episode offers a deep dive into a specific chapter of the book, with insights directly from the authors, Kathryn Knerler, Ingrid Parker, and Carson Zimmerman. The discussions are engaging, informative, and full of practical advice that can be implemented to enhance any security operations center.

- One episode that particularly stood out to me is Strategy 6: Illuminate Adversaries with Cyber Threat Intelligence. This episode is a favorite because it tackles the crucial challenge of prioritizing defensive efforts in the face of limited budgets and time.

- Ingrid, Carson, and Kathryn do an excellent job of explaining how Cyber Threat Intelligence (CTI) can be leveraged to focus on the most likely attacks and attackers. The way they break down complex CTI concepts into actionable steps is incredibly helpful. They emphasize the importance of understanding adversaries’ tactics, techniques, and procedures (TTPs) to better defend against them. This strategic approach ensures that resources are used efficiently and that the security team can make informed decisions that truly matter.

- The insights shared in this episode about using CTI to illuminate adversaries highlight the value of a proactive, intelligence-driven defense strategy. It’s not just about reacting to threats but understanding and anticipating them. This perspective shift is invaluable for any security team looking to stay ahead of cyber threats.



## 2. Investigating WMI Attacks | SANS (https://youtu.be/aBQ1vEjK6v4?si=46XJ8n4EXO62vs7Z)
...
## 3. The Truth about Ransomware: Its not Complicated! | SANS (https://youtu.be/8xAuvl0Cp90?si=legZQxtyjPjuJD5B)
...
## 4. Grow Up! Evaluating and Maturing Your SOC Using MITRE ATT&CK | ATT&CKcon 4.0 (https://youtu.be/8qvP5uDB2wc?si=1B0K4hVCLjzHhp-n)
...
## 5. Find_Evil - Threat Hunting | SANS (https://youtu.be/GrhVz1Sjd_0?si=ycnJQdEEyPu_WZvt)
...
## 6. Detecting & Hunting Ransomware Operator Tools: It Is Easier Than You Think! (https://youtu.be/oMAvSpq9fYY?si=W3rEKARR13Om9pCN)
...
## 7. The Cycle of Cyber Threat Intelligence | SANS (https://youtu.be/J7e74QLVxCk?si=6AQlzojfo84-cfbm)
...
## 8. Hunting and Scoping A Ransomware Attack | SANS (https://youtu.be/h076AA1ZroY?si=BdKLRVbx6xS0f-Bu)
...
## 9. Hunting The Dark Web's King of Ransomware. (https://youtu.be/YaTVlw8c2dE?si=z-XfFZlyS2g1TskN)
